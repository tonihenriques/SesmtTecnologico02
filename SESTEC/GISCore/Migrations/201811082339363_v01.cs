    ...
    public partial class v01 : DbMigration
    {
        public override void Up()
        {
                ...
                c => new
                    {
                        ...
                        UsuarioExclusao = c.String(),
                        DataExclusao = c.DateTime(nullable: false),
                        Empresa_IDEmpresa = c.String(maxLength: 128),
                    })
                .PrimaryKey(t => t.IDEstabelecimento)
                .ForeignKey("dbo.tbDepartamento", t => t.IDDepartamento)
                .ForeignKey("dbo.tbEmpresa", t => t.Empresa_IDEmpresa)
            ...
            CreateTable(
                ...
                c => new
                    {
                        ...
                        idAtividadeAlocada = c.String(maxLength: 128),
                        idAlocacao = c.String(),
                ...
                .ForeignKey("dbo.tbAtividadeAlocada", t => t.idAtividadeAlocada)
                .Index(t => t.idAtividadeAlocada);
