...
function OnSuccessCadastrarMedidasDeControle(data) {
    $('#formCadastroMedidasDeControle').removeAttr('style');
    $(".LoadingLayout").hide();
    $('#btnSalvar').show();
    TratarResultadoJSON(data.resultado);
}

function OnBeginCadastrarMedidasDeControle() {
    $(".LoadingLayout").show();
    $('#btnSalvar').hide();
    $("#formCadastroMedidasDeControle").css({ opacity: "0.5" });
}