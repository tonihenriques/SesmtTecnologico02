...
function DeletarTipoDeRisco(IDTipoDeRisco, Nome) {
        ...
        $.ajax({
            ...
            success: function (content) {
                ...
                if (content.resultado.Sucesso != null && content.resultado.Sucesso != "") {
                    $("#linha-" + IDTipoDeRisco).remove();
                }
            }
        });
    };

    ExibirMensagemDeConfirmacaoSimples("Tem certeza que deseja excluir o Tipo de Risco '" + Nome + "'?", "Exclusão de Tipo de Risco", callback, "btn-danger");
