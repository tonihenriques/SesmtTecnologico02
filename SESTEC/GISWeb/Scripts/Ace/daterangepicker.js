    ...
    DateRangePicker.prototype = {
        ...
        updateInputText: function() {
            if (this.element.is('input') && !this.singleDatePicker) {
                //if ($.trim($("input[name=daterangepicker_start]").val()) == "" && $.trim($("input[name=daterangepicker_end]").val()) != "") {
                //    this.element.val(this.separator + this.endDate.format(this.format));
                //}
                //else if ($.trim($("input[name=daterangepicker_start]").val()) != "" && $.trim($("input[name=daterangepicker_end]").val()) == "") {
                //    this.element.val(this.startDate.format(this.format)  + this.separator);
                //}
                //else {
